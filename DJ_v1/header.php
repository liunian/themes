...
?></title>
	...
	<link rel="stylesheet" href="<?php bloginfo('stylesheet_url')?>?v=83" type="text/css" media="screen" />
	<?php
	if (is_home()){
...
<body>
	<div id="wrapper">
		<div id="header">
			...
			<div id="feed">
				<a href="<?php bloginfo('rss2_url'); ?>" title="rss feed"><img src="<?php bloginfo('template_directory'); ?>/images/rss.png" alt="rss feed" /></a>
			</div>
		</div> <!-- #header -->
		<div id="content">